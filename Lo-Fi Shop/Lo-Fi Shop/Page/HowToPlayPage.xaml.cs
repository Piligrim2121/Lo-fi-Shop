...
namespace Lo_Fi_Shop.Page
{
    ...
    public partial class HowToPlayPage : ContentPage
    {
        ...
        public void Add_Al()
        {
            ...
            Stack.Children.Add(new Image { Source = "Resources/drawable/Education/mainPage.png" });
            ...
            Stack.Children.Add(new Image {Source = "Resources/drawable/Education/Dialog.png "});
